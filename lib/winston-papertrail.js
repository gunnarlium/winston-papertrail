 ...
 *
 * @param {Boolean}     [options.includeMetaInMessage]        output meta as part of the message (true)
 *
 * @type {Function}
 */
var Papertrail = exports.Papertrail = function (options) {
    ...
    // Include meta flag
    self.includeMetaInMessage = options.includeMetaInMessage !== false;
...
Papertrail.prototype.log = function (level, msg, meta, callback) {
    ...
    if (meta && this.includeMetaInMessage) {
...
Papertrail.prototype.processBuffer = function () {
    ...
    console.log('process buffer', this.buffer.length);
...
Papertrail.prototype.close = function() {
    var self = this;
    console.log('close()', Boolean(self.stream));
